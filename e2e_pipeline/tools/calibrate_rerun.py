...
from e2e_pipeline.calibration.calibrate import CalibrationTrace, RiskBudget, calibrate_risk_price
...
from e2e_pipeline.planner.world_model import (
    AnalyticCritic, ReactiveWorldModel, plan_with_world_model)
...
def main():
    ...
    def evaluate(lam):
        import e2e_pipeline.planner.world_model as WM
        old = WM.W_RISK
        WM.W_RISK = float(lam)
        try:
            risks, comps = [], []
