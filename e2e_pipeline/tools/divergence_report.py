...
from e2e_pipeline.metrics.divergence_metrics import (
    StepObs, bucketed_collision_rate, counterfactual_safety,
    progress_per_divergence, recovery_rate)
from e2e_pipeline.metrics.metrics import _agent_poly, _ego_poly, polygon_distance
...
def main():
    ...
    for label in ('GT', 'LIVE'):
        from e2e_pipeline.metrics.divergence_metrics import aggregate_scenes
